                                    ...
                                    <div class="account_profile d-flex justify-content-between align-items-center">
                                        <div class="account_info">
                                            ...
                                            <div class="account_info_inner">
                                                <h3 class="text-2xl fw-600 textDark mb-0">{{$user->first_name}} {{$user->last_name}}</h3>
                                                <p class="desc text-base textDark mb-0">{{$user->description ? $user->description:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Id aliquam officiis aut consequatur vero alias nisi culpa accusantium nemo dolor, quaerat ipsam hic tempora laboriosam commodi tempore laborum harum autem."}}</p>
                                                ...
                                                <div>
                                                    ...
                                                    <div class="mt-10 w-100">
                                                        <div class="form-group upload_profile_img pb-5">
                                                            <img src="{{$user->image}}" alt="Profile" class="aspect-square mx-auto rounded-pill" />
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-md-6">
                                                                <input type="text" name="first_name" placeholder="First name" value="{{$user->first_name}}" class="rounded-pill bg-transparent backdrop-blur border text-white w-100 py-3 px-4" autocomplete="off">
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <input type="text" name="last_name" placeholder="Last name" value="{{$user->last_name}}" class="rounded-pill bg-transparent backdrop-blur border text-white w-100 py-3 px-4" autocomplete="off">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <input type="email" disabled placeholder="Email" value="{{$user->email}}" class="rounded-pill bg-transparent backdrop-blur border text-white w-100 py-3 px-4" autocomplete="off">
                                                        </div>
                                                        <div class="form-group">
                                                            <input type="tel" name="mobile" placeholder="Phone Number" value="{{$user->mobile}}" class="rounded-pill bg-transparent backdrop-blur border text-white w-100 py-3 px-4" autocomplete="off">
                                                        </div>
                                                        <div class="form-group">
                                                            <input type="text" name="address1" placeholder="address" value="{{$user->userAddress ? $user->userAddress->address1:''}}" class="rounded-pill bg-transparent backdrop-blur border text-white w-100 py-3 px-4" autocomplete="off">
                                                        </div>
                                                        <div class="form-group">
                                                            <textarea name="description" id=""  rows="4" placeholder="Bio" value="Lorem ipsum dolor sit amet" class="bg-transparent backdrop-blur border text-white w-100 py-3 px-4 rounded-4"></textarea>
                                                        </div>
                                                        <button type="button" id="updatep" class="btn-light fw-600 w-100 mt-3">Update Profile</button>
                                                    </div>
                                                    </form>
                                                </div>
                                            </div>
...
jQuery(document).ready(function ($) {
    ...
    $("#updatep").on("click", function(e) {
      ...
      $.ajax({
        url: '{{url("/update-profile")}}', // Replace with the URL where your form should be submitted
        method: "POST",
        data: formData,
        processData: false,
        contentType: false,
