        ...
        <div class="container_md py-17">
            <nav aria-label="breadcrumb" class="mt-0 pb-4 mt-lg-5 pb-lg-5">
                <ol class="breadcrumb p-0 bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Update a Tiny Home</li>
                </ol>
            </nav>
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                            <div class="card-body">
                                <div class="upload__box">
                                    ...
                                    <div class="upload__img-wrap " id="imagePreview">
                                    @if(isset($car->cars_images) && $car->cars_images->IsNotEmpty())
                                    @foreach($car->cars_images as $image)
                                    <!-- <div>
                                        <div class="house_img">
                                            <img src="{{ $image->image }}" alt="House" class="img-fluid" />
                                        </div>
                                    </div> -->
                                    <div class='upload__img-box'><div style='background-image: url({{ $image->image }})'  class='img-bg'><div class='upload__img-close' id="{{ $image->id }}"></div></div></div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6 col-lg-4">
                                            ...
                                            <select name="category_id" id="category_id" class="form-control" required>
                                                ...
                                                <option value="{{$listing->id}}" @if($listing->id==$car->category_id) selected @endif>{{$listing->title}}</option>
                                                @empty
                                                @endforelse
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6 col-lg-4">
                                            ...
                                            <select name="condition" id="condition" class="form-control">
                                                ...
                                                <option value="{{$listing->name}}" @if($listing->name == $car->condition) selected @endif>{{$listing->name}}</option>
                                                @empty
                                                @endforelse
                                            </select>
                                        </div>
                                        <div class="form-group col-md-6 col-lg-4">
                                            ...
                                            <select name="year" id="" class="form-control">
                                                ...
                                                <option value="{{$listing->name}}" @if($listing->name == $car->year) selected @endif>{{$listing->name}}</option>
                                                @empty
                                                @endforelse
                                            </select>
                                        </div>
                                        <div class="form-group  cus_select col-md-6 col-lg-4">
                                            ...
                                            <select name="make" id="makeSelect" class="form-control">
                                                ...
                                                <option value="{{$listing->name}}" @if($listing->name == $car->make) selected @endif>{{$listing->name}}</option>
                                                @empty
                                                @endforelse
                                            </select>
                                        </div>
                                        <div class="form-group  cus_select col-md-6 col-lg-4">
                                            ...
                                            <select name="model" id="makeSelect2" class="form-control">
                                                ...
                                                <option value="{{$listing->name}}"  @if($listing->name == $car->model) selected @endif>{{$listing->name}}</option>
                                                @empty
                                                @endforelse
                                            </select>
                                        </div>
                                        <div class="form-group col-md-6 col-lg-4">
                                            ...
                                            <select name="engine_size" id="" class="form-control">
                                                ...
                                                <option value="{{$listing->name}}"  @if($listing->name == $car->engine_size) selected @endif>{{$listing->name}}</option>
                                                @empty
                                                @endforelse
                                            </select>
                                        </div>
                                        <div class="form-group col-md-6 col-lg-4">
                                            ...
                                            <select name="mileage" id="" class="form-control">
                                                ...
                                                <option value="{{$listing->name}}"  @if($listing->name == $car->mileage) selected @endif>{{$listing->name}}</option>
                                                @empty
                                                @endforelse
                                            </select>
                                        </div>
                                        <div class="form-group col-md-6 col-lg-4">
                                            ...
                                            <select name="car_type" id="" class="form-control">
                                                ...
                                                <option value="{{$listing->name}}"  @if($listing->name == $car->car_type) selected @endif>{{$listing->name}}</option>
                                                @empty
                                                @endforelse
                                            </select>
                                        </div>
                                        <div class="form-group col-md-6 col-lg-4">
                                            ...
                                            <select name="title_status" id="" class="form-control">
                                                ...
                                                <option value="{{$listing->name}}"  @if($listing->name == $car->title_status) selected @endif >{{$listing->name}}</option>
                                                @empty
                                                @endforelse
                                        ...
                                        <div class="form-group col-md-6 col-lg-4">
                                            ...
                                            <select name="availability" id="" class="form-control">
                                                ...
                                                <option value="{{$listing->name}}"  @if($listing->name == $car->availability) selected @endif >{{$listing->name}}</option>
                                                @empty
                                                @endforelse
                                        ...
                                        <div class="form-group col-md-6 col-lg-4">
                                            ...
                                            <select name="frame_construction" id="" class="form-control">
                                                ...
                                                <option value="{{$listing->name}}"  @if($listing->name == $car->frame_construction) selected @endif >{{$listing->name}}</option>
                                                @empty
                                                @endforelse
                                ...
                                <div class="other_detail mb-4">
                                    <div class="form-group">
                                        ...
                                        <div class="inner_group">
                                            ...
                                            <input type="text" name="amount" value="{{$car->amount}}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="">Description <span>(optional)</span></label>
                                        <textarea name="description" id="editor" placeholder="" rows="4" class="form-control" spellcheck="false">
                                            {{$car->description}}
                                        </textarea>
                                    </div>
                                ...
                                <div class="other_detail mb-4">
                                    <div class="form-group">
                                        ...
                                        <div class="inner_group">
                                            ...
                                            <input type="text" name="car_address" id="locationInput" value="{{$car->car_address}}" placeholder="" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="">Post Code</label>
                                        <input type="number" name="zip_code" value="{{$car->zip_code}}" id="zip_code" placeholder="" class="form-control">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="national_shipping" id="" class="form-control">
                                            ...
                                            <option value="{{$listing->name}}" @if($listing->name == $car->national_shipping) selected @endif>{{$listing->name}}</option>
                                            @empty
                                            @endforelse
...
jQuery(document).ready(function ($) {
    ...
    formData.append('description', ckEditorContent);
      ...
      $.ajax({
        url: '{{url("/update-post")}}', // Replace with the URL where your form should be submitted
        method: "POST",
        data: formData,
        processData: false,
        contentType: false,
