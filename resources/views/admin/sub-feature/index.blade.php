            ...
            <div class="page-header-content header-elements-lg-inline">
                ...
                <div class="header-elements d-none">
                    <div class="d-flex justify-content-center">
                        <a href="{{ route('featurelist.index') }}" type="button" class="btn btn-primary">Back</a>
                        <a href="{{ route('sub-feature.create', ['cid' => $data['vehicle_companies_id']]) }}" type="button" class="btn btn-primary" style="margin-left: 5px;">Add</a>

                        <form style="margin-left: 5px;" action="{{ route('sub-feature.index') }}">
                ...
                <div class="table-responsive">
                    <table class="table my-datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="list-icons">
                                        <a href="{{ route('sub-feature.edit', [$value['id'], 'cid' => $data['vehicle_companies_id']]) }}" class="list-icons-item text-primary" title="Edit"><i class="icon-pencil7"></i></a>
                            ...
                            <form action="{{ route('sub-feature.delete', [$value['id']]) }}" method="GET">
                             @csrf
