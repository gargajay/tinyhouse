        ...
        <div class="content-inner">
                ...
                <div class="page-header-content header-elements-lg-inline">
                    ...
                    <div class="header-elements d-none">
                        <div class="d-flex justify-content-center">
                            <a href="{{ route('sub-feature.index', ['cid' => $data['parent_id']]) }}" type="button"
            ...
            <div class="content">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('sub-feature.update', [$data['id']]) }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PUT') }}
                            <input type="hidden" name="vehicle_companies_id" value="{{ $data['parent_id'] }}">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <input name="spanish_title" class="form-control form-control-lg" type="text"
                                                    placeholder="Title" value="{{ $data['es_title'] }}" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
