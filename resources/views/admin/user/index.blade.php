                                    ...
                                    <div class="list-icons">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a href="{{ route('user.show', [$value['id']]) }}" class="dropdown-item"><i class="icon-eye"></i>Detail</a>
                                                @if($value['deleted_at'] == null)
                                                <a href="{{ route('user.delete', [$value['id'],'is_status= Enable']) }}" class="dropdown-item"><i class="fa fa-ban"></i>Block</a>
                                                @else

                                                <a href="{{ route('user.delete',[$value['id'],'is_status= Disable']) }}" class="dropdown-item"><i class="fa fa-ban"></i>Unblock</a>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
