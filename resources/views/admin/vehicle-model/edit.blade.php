        ...
        <div class="content-inner">
                ...
                <div class="page-header-content header-elements-lg-inline">
                    ...
                    <div class="header-elements d-none">
                        <div class="d-flex justify-content-center">
                            <a href="{{ route('vehicle-model.index', ['cid' => $data['vehicle_companies_id']]) }}" type="button"
            ...
            <div class="content">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('vehicle-model.update', [$data['id']]) }}" method="POST"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <input name="title" class="form-control form-control-lg" type="text"
                                                    placeholder="Title" value="{{ $data['model_name'] }}" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
