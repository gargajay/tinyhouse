            ...
            <div class="page-header-content header-elements-lg-inline">
                ...
                <div class="header-elements d-none">
                    <div class="d-flex justify-content-center">
                        ...
                        <a href="{{ route('vehicle-model.create', ['cid' => $data['vehicle_companies_id']]) }}" type="button" class="btn btn-primary" style="margin-left: 5px;">Add</a>

                        <form style="margin-left: 5px;" action="{{ route('vehicle-model.index') }}">
                          <input type="hidden" name="cid" value="{{ $data['vehicle_companies_id']}}">
                ...
                <div class="table-responsive">
                    <table class="table my-datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $key + 1 }}</td>
                                {{-- <td>{{ $value['vehicle_companies_id'] ?? '' }}</td> --}}
                                <td>{{ $value['model_name'] ?? '' }}</td>
                                <td>
                                    <div class="list-icons">
                                        <a href="{{ route('vehicle-model.edit', [$value['id'], 'cid' => $data['vehicle_companies_id']]) }}" class="list-icons-item text-primary" title="Edit"><i class="icon-pencil7"></i></a>
                                        <a href="{{ route('vehicle-model.delete', [$value['id'], 'cid' => $data['vehicle_companies_id']]) }}" class="list-icons-item text-danger" title="Delete"><i class="icon-trash"></i></a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
