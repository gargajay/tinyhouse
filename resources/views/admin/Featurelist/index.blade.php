                ...
                <div class="page-header-content header-elements-lg-inline">
                    ...
                    <div class="header-elements d-none">
                        <div class="d-flex justify-content-center">
                            <a href="{{ route('featurelist.create') }}" type="button" class="btn btn-primary">Add</a>
                            <form style="margin-left: 5px;" action="{{ route('featurelist.index') }}">
                            ...
                            <tbody>
                                @if (count($result) > 0)
                                    ...
                                    @foreach ($result as $key => $value)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="list-icons">
                                                    <a href="{{ route('featurelist.edit', [$value['id']]) }}"
                                                     ...
                                                     <a href="{{ route('sub-feature.index', ['cid' => $value['id']]) }}"
                                                        class="list-icons-item text-primary" title="sub-feature"><i
                                      ...
                                      <form action="{{ route('featurelist.delete', [$value['id']]) }}" method="GET">
                                       @csrf
