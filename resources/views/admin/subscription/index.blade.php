            ...
            <div class="page-header-content header-elements-lg-inline">
                ...
                <div class="header-elements d-none">
                    <div class="d-flex justify-content-center">
                        <a href="{{ route('subscription.create') }}" type="button" class="btn btn-primary">Add</a>
                        <form style="margin-left: 5px;" action="{{ route('subscription.index') }}">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="list-icons">
                                        <a href="{{ route('subscription.edit', [$value['id']]) }}" class="list-icons-item text-primary" title="Edit"><i class="icon-pencil7"></i></a>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <form action="{{ route('subscription.delete', [$value['id']]) }}" method="GET">
                                                @csrf
