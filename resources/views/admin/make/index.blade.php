                ...
                <div class="page-header-content header-elements-lg-inline">
                    ...
                    <div class="header-elements d-none">
                        <div class="d-flex justify-content-center">
                            ...
                            <a href="{{ route('make.create') }}" type="button" class="btn btn-primary">Add</a>

                            <form style="margin-left: 5px;" action="{{ route('make.index') }}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="list-icons">
                                                    <a href="{{ route('make.edit', [$value['id']]) }}"
                                                        class="list-icons-item text-primary" title="Edit"><i
                                                            class="icon-pencil7"></i></a>
                                                    <a href="{{ route('make.show', [$value['id']]) }}"
